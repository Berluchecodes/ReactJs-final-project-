    ...
    <div className={`w-full h-[550px] text-black ${show ? '' : 'hidden'}`}>
        <div className='w-full h-[450px]'>
          ...
          <div className='absolute w-full top-[20%] p-4 md:p-8'>
            ...
            <div className='my-4'>
                <button className='border bg-gray-300 text-black border-gray-300 py-2 px-5'>Learn-More</button>
            </div>
            <p className='text-gray-800 text-sm '>Released: {movie?.release_date}</p>
